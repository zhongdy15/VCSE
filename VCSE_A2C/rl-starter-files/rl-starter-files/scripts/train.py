...
parser.add_argument("--test_value_condition", action="store_true", default=False)
parser.add_argument("--use_nextstate_entropy_reward", action="store_true", default=False)
parser.add_argument("--use_ksg", action="store_true", default=False)
...
if args.algo == "a2c":
    algo = torch_ac.A2CAlgo(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                            ...
                            use_value_condition=args.use_value_condition,
                            use_nextstate_entropy_reward=args.use_nextstate_entropy_reward,
                            use_ksg=args.use_ksg,
                            test_value_condition=args.test_value_condition)
elif args.algo == "ppo":
